<script>
	import { formatTimestamp } from '@output/ContentCalendar.Helpers';
	import { copyToClipboard } from '@output/ContentCalendar.Actions';
	...
	<div class="p-6">
		<div class="flex gap-5">
			<div class="group relative flex-shrink-0 cursor-help">
				...
				<!-- Tooltip -->
				<div
					class="bg-opacity-95 invisible absolute left-0 z-50 mb-3 w-72 rounded-xl border border-gray-700 bg-gray-900 p-4 text-[11px] text-white shadow-2xl backdrop-blur-sm group-hover:visible"
				>
					<p
			...
			<div class="flex-1">
				...
				<p class="text-[13px] leading-relaxed font-medium whitespace-pre-wrap text-gray-700">
					{item.post.pContent}
				</p>
			</div>
		</div>
